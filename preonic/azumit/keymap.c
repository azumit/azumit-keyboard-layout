/*
 * Azumit key layout. Dvorak default, with selectable qwerty layer. Row 1 contains macros and shortcuts, numbers are under the sym layer on row 2.
 */
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    */
    [_DVORAK] = LAYOUT_preonic_grid(
        KC_ESC, DTOP_L, DTOP_R, KC_F4, KC_F5, AUTO_FORMAT, COMMENT, KC_F12, KC_MPLY, KC_VOLD, KC_VOLU, LOCK,
        KC_ESC, KC_QUOT, KC_COMM, KC_DOT, KC_P, KC_Y, KC_F, KC_G, KC_C, KC_R, KC_L, KC_SLSH,
        KC_TAB, KC_A, KC_O, KC_E, KC_U, KC_I, KC_D, KC_H, KC_T, KC_N, KC_S, KC_MINS,
        KC_LPRN, KC_SCLN, KC_Q, KC_J, KC_K, KC_X, KC_B, KC_M, KC_W, KC_V, KC_Z, KC_RPRN,
        LCTL_T(KC_LBRC), TD(ALT_LCBR), KC_LGUI, KC_DEL, LT(_NAV, KC_BSPC), KC_LSFT, KC_SPC, LT(_SYM, KC_ENT), LT(_NAV, KC_BSLS), LT(_FUNC, KC_EQL), TD(ALT_RCBR), RCTL_T(KC_RBRC)),
    /* Qwerty
      ,-----------------------------------------------------------------------------------.
    ...
    */
    [_QWERTY] = LAYOUT_preonic_grid(
        KC_PPLS, KC_1, KC_2, KC_3, KC_4, KC_5, KC_6, KC_7, KC_8, KC_9, KC_0, KC_BSPC,
    ...
    * |Shift |   :  |  =>  |   J  |   .  |   X  |  :)  |   .  |   [  |   ]  |   :  |   )  |
    * |------+------+------+------+------+------+------+------+------+------+------+------|
    * |[ Ctrl| { Alt|  Gui | DelWd|SymBsp| Shift| Space|Fn Ent| / Nav|   =  | } Alt|] Ctrl|
    * `-----------------------------------------------------------------------------------'
    */
    ...
    /* Navigation
    * ,-----------------------------------------------------------------------------------.
    * |Ctrl1 |Ctrl2 |Ctrl3 |Ctrl4 |  F5  |Format|Commnt|  F12 |  CAD | Vol- | Vol+ |  Del |
    * |------+------+------+------+------+------+------+------+------+------+------+------|
    * |  Gui | Home | CLeft|CRight|  End |   Y  |   F  |   G  |   7  |   8  |   9  |  -   |
    * |------+------+------+------+------+-------------+------+------+------+------+------|
    * |PrtScr| Left | Down |  Up  | Right|   G  |   D  |   H  |   4  |   5  |   6  |  +   |
    * |------+------+------+------+------+------|------+------+------+------+------+------|
    * |Shift |Ctrl1 |Ctrl2 |Ctrl3 |Ctrl4 |Macro1|Macro2|   M  |   1  |   2  |   3  |  *   |
    * |------+------+------+------+------+------+------+------+------+------+------+------|
    * |[ Ctrl| { Alt|  Gui |  Del |SymBsp| Shift| Space|Fn Ent| / Nav|   0  |   .  |  Ent |
    * `-----------------------------------------------------------------------------------'
    */
    [_NAV] = LAYOUT_preonic_grid(
        C(KC_1), C(KC_2), C(KC_3), C(KC_4), _______, _______, _______, _______, _______, _______, _______, KC_SLSH,
        KC_LGUI, KC_HOME, C(KC_LEFT), C(KC_RIGHT), KC_END, _______, _______, _______, KC_7, KC_8, KC_9, KC_PMNS,
        ...
        _______, _______, _______, C(KC_BSPC), _______, _______, _______, _______, _______, KC_0, KC_DOT, KC_ENT),
    /* Function 
    * ,-----------------------------------------------------------------------------------.
    * | Esc  |Ctrl1 |Ctrl2 |Ctrl3 |Ctrl4 |Format|Commnt|  F12 |Music |MusMod|Dvorak|Qwerty|
    * |------+------+------+------+------+------+------+------+------+------+------+------|
    * | Esc  |<-DTOP|DTOP->|  F4  |  F5  |Format|Commnt|  F12 |  CAD | Vol- | Vol+ | Lock |
    * |------+------+------+------+------+-------------+------+------+------+------+------|
    * |  F1  |  F2  |  F3  |  F4  |  F5  |  F6  |  F7  |  F8  |  F9  |  F10 |  F11 |  F12 |
    ...
    * |------+------+------+------+------+------+------+------+------+------+------+------|
    * |[ Ctrl| { Alt|  Gui |  Del |SymBsp| Shift| Space|Fn Ent|Rec St| Func |Rec M1|Rec M2|
    * `-----------------------------------------------------------------------------------'
    */
    [_FUNC] = LAYOUT_preonic_grid(
        _______, C(KC_1), C(KC_2), C(KC_3), C(KC_4), _______, _______, _______, MU_TOG, MU_MOD, DVORAK, QWERTY,
